        ...
        portfolioItems: [
            {
                name: 'Sudoku Game',
                nameCh: '數獨遊戲',
                detail: ['運用 Vue.js，實現數獨動態互動界面和數據反應。', 
                        '透過 Axios 處理非同步 API 請求，實時更新遊戲數據。',
                        '設計清晰的數字輸入介面，提升用戶操作體驗。'],
                image: 'img_sudoku.png',
                // link: 'https://revolmusic23.github.io/NBA-Stats-of-League-Leaders/'
                link: 'https://revolmusic23.github.io/Sudoku-Game/'
            },
            {
            ...
            },
            {
                ...
                image: 'img_college-project.jpeg',
